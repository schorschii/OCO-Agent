...
2. Manually execute the script as root/Administrator in terminal to check its functionality.
3. Set up a cron job executing the script as root/Administrator every minute.
